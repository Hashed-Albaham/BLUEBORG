...
export default function CmsPagePreview() {
  ...
  return <main className="client-page" dir="rtl"><header><a href="/"><Building2 size={18} /> البرج الأزرق المتحدة</a><nav><a href="/">الموقع الرئيسي</a><a href="/admin">لوحة الإدارة</a></nav></header><div id="client-content">{page.blocks.filter((block) => block.enabled).map((block, index) => <BlockRenderer block={block} index={index} key={block.id} />)}</div><footer>نسخة معاينة للمحتوى المُدار — {page.title}</footer></main>;
}
